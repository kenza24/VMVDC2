...
<div  class="container">
  <div class="shadow-lg p-3 mb-5 bg-blue rounded" style="background-color: #B0C4DE;">
    ...
    <div class="d-flex flex-row p-2 justify-content-center" >
      ...
      <a type="button" class="btn btn-outline-secondary col-4 text-break" href={{('modificationInfosD')}} >Modifier mes informations</a>
      ...
      <form method="post" action={{route('suppressionD')}}  onsubmit="return confirm('Etes-vous sur ?');" class="col-12 pl-0 pr-0">
        {{csrf_field()}}
        <button type="submit" class="btn btn-outline-danger col-12">Supprimer mon compte</button>
      </form>
    </div>
  </div>
  </div>
