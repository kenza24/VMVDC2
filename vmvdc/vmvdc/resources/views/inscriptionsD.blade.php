...
<div class="container" action="/inscriptionsD">
...
<article class="card-body mx-auto" style="max-width: 400px;font-family: Georgia, serif;">
	...
	<form action="/inscriptionsD" method="post">
  ...
  <!--NOM/PRENOM-->
        ...
        <input name="nomD" class="form-control" placeholder="Nom" type="text">
        <input name="prenomD" class="form-control" placeholder="Prenom" type="text">
    </div> <!-- form-group// -->
    ...
    <div class="form-group input-group">
        ...
        <input class="form-control" placeholder="Confimer le mot de passe" type="password" name="mdp-confirmationD">
    </div> <!-- form-group// -->
